...
import 'package:asset_picker/src/widget/insta_asset_picker_delegate.dart';
...
class FlowkarAssetPicker {
  ...
  static Future<PermissionState> _permissionCheck(RequestType? requestType) => AssetPicker.permissionCheck(
  ...
  static void _openErrorPermission(
    ...
    final defaultDescription = '${text.unableToAccessAll}\n${text.goToSystemSettings}';
  ...
  static void _assertRequestType(RequestType requestType) {
    assert(requestType == RequestType.image || requestType == RequestType.video || requestType == RequestType.common, 'Only images and videos can be shown in the picker for now');
  }
